...
zlzh = ['18014246678_p', 'jd_FdDjJBENiJzA', '18915299015_p','jd_41c752f800930','jd_oKMcRZnuBXfM','269569205']
#####
...
try:
    ...
    print("请先下载依赖脚本，\n下载链接：https://raw.githubusercontent.com/acoolbook/lxkwz/main/jd_tool_dl.py")
    sys.exit(3)
import time
