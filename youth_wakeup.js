...
[task_local]
#中青看点打卡赚钱
34 5,9 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_connoisseur.js, tag=中青看点打卡赚钱, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "34 5,9 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_connoisseur.js,tag=中青看点打卡赚钱

===============Surge=================
中青看点打卡赚钱 = type=cron,cronexp="15 3,6 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_connoisseur.js

============小火箭=========
中青看点打卡赚钱 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_connoisseur.js, cronexpr="15 3,6 * * *", timeout=3600, enable=true
 */
const $ = new Env("中青看点打卡赚钱");
const notify = $.isNode() ? require('./sendNotify') : '';
message = ""
let zq_cookie= $.isNode() ? ((process.env.zq_cookie ? process.env.zq_cookie : "")?process.env.zq_cookie:(process.env.YOUTH_HEADER ? process.env.YOUTH_HEADER : "")) : ($.getdata('zq_cookie') ? $.getdata('zq_cookie') : "")
let zq_cookieArr = []
let zq_cookies = ""
var myDate = new Date();
